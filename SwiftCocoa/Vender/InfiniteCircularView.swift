...
class InfiniteCircularView: UIView {
    ...
    fileprivate lazy var contentCollectionView:UICollectionView = {
        let vi = UICollectionView(frame: self.bounds, collectionViewLayout: InfiniteCircularLayout())
        vi.register(InfiniteCircularCollectionViewCell.self, forCellWithReuseIdentifier: "InfiniteCircularCollectionViewCellID")
    ...
    fileprivate lazy var pageControl:UIPageControl = {
        ...
        pc.pageIndicatorTintColor = 0x6B6B6B.HexColor
...
extension InfiniteCircularView:UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "InfiniteCircularCollectionViewCellID", for: indexPath) as! InfiniteCircularCollectionViewCell
...
class InfiniteCircularLayout: UICollectionViewFlowLayout {
...
class InfiniteCircularCollectionViewCell: UICollectionViewCell {
    ...
    fileprivate func initView() {
        ...
        contentView.addSubview(conImageView)
    }
